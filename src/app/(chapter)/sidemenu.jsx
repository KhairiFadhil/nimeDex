    ...
    return(
        ...
        <div className="flex w-full h-[150px] relative flex-col justify-center bg-gray-900 ">
            ...
            <div className="h-[full] w-[120x] flex">
                <button className="h-[full] w-full text-2xl group transition-all active:text-red-50 hover:text-gray-100 flex items-center text-gray-400"><IoIosArrowBack className="text-6xl"/><span className="">Previous Chapter</span></button>
            ...
            <div className="h-[full] w-[120x] flex">
                <button className="h-[full] w-full text-2xl flex items-center transition-all active:text-red-50 hover:text-gray-100 text-gray-400"><span className="">Next Chapter</span><IoIosArrowForward className="text-6xl"/></button>
